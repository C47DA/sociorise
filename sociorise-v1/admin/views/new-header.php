  ...
  <header>
    ...
    <div class="mobile-navbar">
      <div class="logo-details">
        <div class="logo_name">Rental official</div>
      </div>
      ...
      <ul class="nav-list">
        ...
        ?>">
          ...
          <div class="content">
            <a class="nav-link" href="<?php echo site_url("admin/settings/general"); ?>"> General</a>
            <a class="nav-link" href="<?php echo site_url("admin/settings/providers"); ?>"> Sellers</a>
            <a class="nav-link <?php if(route(2) == "paymentMethods"){echo "active";}?>" href="<?php echo site_url("admin/settings/paymentMethods"); ?>"> Payment Methods</a>

            <a class="nav-link" href="<?php echo site_url("admin/settings/modules"); ?>"> Modules</a>
            <a class="nav-link" href="<?php echo site_url("admin/settings/subject"); ?>"> Support</a>
            <a class="nav-link" href="<?php echo site_url("admin/settings/currency-manager"); ?>"> Site Currency Manager</a>
            <a style="font-size:14px;" class="nav-link" href="<?php echo site_url("admin/settings/alert"); ?>"> Notifications</a>
            <a class="nav-link" href="<?php echo site_url("admin/settings/site_count"); ?>">< Fake orders</a>
          </div>
        </li>
